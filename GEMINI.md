...
- **UX Consistency**: Ajout d'une "dead zone" (padding-bottom) sur la liste des transactions pour éviter que la navigation flottante et le FAB ne masquent les derniers éléments, uniformisant le comportement avec le reste de l'application.
...
-Every time you make a notable change, update this file.
-Unless told otherwise, always plan your work. Only after receiving approval, proceed with implementation.
